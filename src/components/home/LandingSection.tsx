  ...
  return (
    <div className="relative h-screen w-full landing-bg">
      ...
      <div className="h-full max-w-screen-xl mx-auto flex flex-col justify-center items-center px-4 pt-20 pb-4 relative z-10">
        <div className="relative flex justify-center items-center pt-14 pb-20 md:pb-12">
          <LandingImage />
        ...
        <div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-center font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-violet-500">
            #Tech Meets Culture
          </h1>
