...
export const ScheduleCard: React.FC<ScheduleCardProps> = ({ events }) => {
  return (
    <div className="max-w-md relative overflow-hidden rounded-2xl border border-stone-700 bg-black/60 backdrop-blur-lg p-4 sm:p-6 md:p-10 h-auto shadow-xl shadow-indigo-500/20 group transition-all duration-300 hover:shadow-indigo-500/40">
